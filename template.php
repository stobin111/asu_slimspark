...
function asu_normal_menuitem_has_active_children($menuitem) {
  ...
  if (module_exists('tb_megamenu') && ($menu_tree = tb_megamenu_get_tree('main-menu'))) {
    ...
    foreach ($menu_tree as $item) {
      if (isset($item['link']) && $item['link']['access'] && !$item['link']['hidden']) {
        ...
        // Render child items.
        if (asu_normal_menuitem_has_active_children($item)) {
          ...
          foreach ($item['below'] as $child) {
            if (isset($child['link']) && !$child['link']['hidden']) {
              ...
              if (asu_normal_menuitem_has_active_children($child)) {
